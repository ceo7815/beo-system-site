...
export const posts: BlogPost[] = [
  ...
  },
  {
    ...
    body: {
      he: [
        ...
        { type: "h2", text: "שאלות נפוצות לפני שמתחילים" },
        { type: "p", text: "מתי שווה סוכן AI ללידים ולא רק צ׳אט באתר? כשיש פניות שנכנסות, אבל אין תהליך אחד שמגיע ל־CRM ולצוות בזמן. צ׳אט עונה. סוכן מסווג, כותב למערכת, ושולח לוואטסאפ לפי כלל." },
        { type: "p", text: "כמה זמן עד שרואים משפך עובד? ספרינט ראשון על תהליך אחד צר — מהאתר או מ־/#contact עד וואטסאפ. בלי «מחלקת AI» שלמה מראש." },
        { type: "p", text: "מה צריך להכין לפני שפונים לביו סיסטם? איפה הלידים נכנסים היום, איזו מערכת היא מקור האמת, ומי מאשר שיחה או הצעה." },
        { type: "p", text: "איך יוצרים קשר עכשיו? וואטסאפ או טופס באתר. משאירים פנייה קצרה — מה העסק ומה נשבר במשפך." },
        { type: "h2", text: "רוצים לבדוק את המשפך שלכם" },
        { type: "p", text: "דברו בוואטסאפ או השאירו פנייה באתר. נבדוק יחד אם סוכן לידים מתאים לתהליך שלכם." },
        { type: "p", text: "https://wa.me/33632519053?text=%D7%94%D7%99%D7%99%2C%20%D7%90%D7%A9%D7%9E%D7%97%20%D7%9C%D7%93%D7%91%D7%A8%20%D7%A2%D7%9C%20%D7%A1%D7%95%D7%9B%D7%9F%20AI%20%D7%9C%D7%9C%D7%99%D7%93%D7%99%D7%9D" },
        { type: "p", text: "https://beosystem.com/#contact" },
      ],
      en: [
        {
          type: "p",
        ...
        { type: "h2", text: "FAQ before you start" },
        { type: "p", text: "When is an AI lead agent better than a site chat? When leads arrive but nothing reliably reaches CRM and the team on time. Chat answers. An agent classifies, writes to systems, and sends WhatsApp by rule." },
        { type: "p", text: "How long until a working funnel? One narrow sprint — from the site or /#contact to WhatsApp. Not a full «AI department» first." },
        { type: "p", text: "What to prepare before contacting Beo System? Where leads enter today, which system is the source of truth, and who approves a call or quote." },
        { type: "p", text: "How to reach us now? WhatsApp or the site form. Leave a short note — what the business is and where the funnel breaks." },
        { type: "h2", text: "Want to check your funnel" },
        { type: "p", text: "Message on WhatsApp or leave a note on the site. We’ll see if a lead agent fits your process." },
        { type: "p", text: "https://wa.me/33632519053?text=%D7%94%D7%99%D7%99%2C%20%D7%90%D7%A9%D7%9E%D7%97%20%D7%9C%D7%93%D7%91%D7%A8%20%D7%A2%D7%9C%20%D7%A1%D7%95%D7%9B%D7%9F%20AI%20%D7%9C%D7%9C%D7%99%D7%93%D7%99%D7%9D" },
        { type: "p", text: "https://beosystem.com/#contact" },
      ],
    },
  ...
  },
  {
    ...
    date: "2026-09-09",
    minutes: 6,
    image: "/blog/crm-custom-fit.webp",
    imageAlt: {
      he: "מערכת CRM בהתאמה שמחברת לקוחות, מכירות ותפעול",
      en: "A custom CRM connecting customers, sales, and operations",
    },
    title: {
      he: "CRM בהתאמה — מתי אקסל ווואטסאפ כבר לא מספיקים",
      en: "Custom CRM — when spreadsheets and WhatsApp stop scaling",
    },
    excerpt: {
      he: "CRM טוב לא כופה תהליך זר. הוא יושב על איך שהעסק באמת מוכר ומטפל בלקוחות — בישראל ובדובאי.",
      en: "A good CRM doesn’t force a foreign process. It sits on how the business actually sells and serves — in Israel and Dubai.",
    },
    body: {
      he: [
        { type: "p", text: "בתחילת הדרך אקסל עובד. אחר כך מתווספים וואטסאפ, תיקיות, ו«מי שזוכר». הליד נכנס, אבל אף אחד לא יודע באיזה שלב הוא — ומי אמור לחזור אליו." },
        { type: "p", text: "ביו סיסטם (ביוסיסטם, Beo System) בונה CRM בהתאמה כשהתהליך כבר קיים בראש של הצוות, אבל הכלים מפזרים אותו בין מסכים." },
        { type: "h2", text: "סימנים שאקסל כבר נשבר" },
        { type: "p", text: "אותו לקוח מופיע בשלושה קבצים. סטטוסים שונים בין אנשים. דוח שבועי נבנה ידנית. ופנייה חדשה מחכה כי «עוד לא עדכנו את הטבלה»." },
        { type: "p", text: "אם הצוות מבלה יותר בלעדכן מערכות מאשר לדבר עם לקוחות — זה לא בעיית משמעת. זה סימן שהכלי לא תואם את התהליך." },
        { type: "h2", text: "CRM מדף מול CRM בהתאמה" },
        { type: "p", text: "כלי מדף מביא שדות ושלבים מוכנים. לפעמים זה מספיק. לפעמים העסק נאלץ לעבוד מסביב לתוכנה — וזה בדיוק איפה שהזמן נשרף." },
        { type: "p", text: "CRM בהתאמה מתחיל מהתהליך: איך נכנס ליד, מתי עוברים להצעה, מי מאשר, איך נסגר שירות. השדות וההרשאות נבנים אחרי זה — לא לפני." },
        { type: "h2", text: "מה חייב להיות ברור לפני שמתחילים" },
        { type: "p", text: "מי הלקוח שלכם (B2B, שטח, פרויקטים). איפה הלידים נכנסים היום. מה מקור האמת הנוכחי. ומי חייב לאשר לפני שליחה או התחייבות." },
        { type: "p", text: "בלי ארבע התשובות האלה — כל מערכת, גם יפה, תהפוך לאקסל משודרג עם יותר כפתורים." },
        { type: "h2", text: "איך ביו סיסטם ניגשת לזה" },
        { type: "p", text: "ספרינט ראשון על ליבה אחת: לידים עד סגירה, או לקוחות עד שירות — לא «כל החברה ביום אחד». אחר כך חיבורים: אתר, וואטסאפ, סוכן AI, דוחות." },
        { type: "p", text: "המטרה: תמונה אחת של הלקוח, פחות העתקה, וצוות שיודע מה הצעד הבא בלי לשאול בקבוצה." },
        { type: "h2", text: "שאלות נפוצות לפני שפונים" },
        { type: "p", text: "מתי שווה CRM בהתאמה ולא רק גיליון? כשיש יותר מאדם אחד על אותו משפך, וכשסטטוסים מתפזרים בין וואטסאפ לקבצים." },
        { type: "p", text: "כמה זמן עד שרואים מערכת חיה? ספרינט צר על תהליך אחד. קודם מסך שעובד — אחר כך הרחבות." },
        { type: "p", text: "האם אפשר לחבר סוכן AI אחר כך? כן — אם יש מקור אמת. בלי CRM או תור מסודר, הסוכן רק מאיץ בלבול." },
        { type: "p", text: "איך יוצרים קשר עכשיו? וואטסאפ או טופס באתר. כותבים בקצרה מה העסק ואיפה נשבר הניהול היום." },
        { type: "h2", text: "רוצים לבדוק אם מתאים לכם" },
        { type: "p", text: "משאירים פנייה קצרה — נבדוק יחד אם CRM בהתאמה או חיבור לכלים הקיימים הוא הצעד הנכון." },
        { type: "p", text: "https://wa.me/33632519053?text=%D7%94%D7%99%D7%99%2C%20%D7%90%D7%A9%D7%9E%D7%97%20%D7%9C%D7%93%D7%91%D7%A8%20%D7%A2%D7%9C%20CRM%20%D7%91%D7%94%D7%AA%D7%90%D7%9E%D7%94" },
        { type: "p", text: "https://beosystem.com/#contact" },
      ],
      en: [
        { type: "p", text: "Early on, a spreadsheet works. Then WhatsApp threads and «whoever remembers» pile up. Leads arrive, but nobody knows the stage — or who should reply." },
        { type: "p", text: "Beo System (ביו סיסטם) builds custom CRM when the process already lives in the team’s head, but tools scatter it across screens." },
        { type: "h2", text: "Signs the spreadsheet already broke" },
        { type: "p", text: "The same customer in three files. Different statuses per person. A weekly report built by hand. A new lead waiting because «the sheet wasn’t updated yet»." },
        { type: "p", text: "If the team spends more time updating tools than talking to customers — it’s not discipline. The tool doesn’t match the process." },
        { type: "h2", text: "Off-the-shelf CRM vs custom fit" },
        { type: "p", text: "Packaged CRM brings ready fields and stages. Sometimes that’s enough. Sometimes the business works around the software — and that’s where time burns." },
        { type: "p", text: "Custom CRM starts from the process: how a lead enters, when a quote goes out, who approves, how service closes. Fields and permissions come after — not before." },
        { type: "h2", text: "What must be clear before you start" },
        { type: "p", text: "Who your customer is (B2B, field, projects). Where leads enter today. What the current source of truth is. And who must approve before a send or commitment." },
        { type: "p", text: "Without those four answers — any system, even a pretty one, becomes a spreadsheet with more buttons." },
        { type: "h2", text: "How Beo System approaches it" },
        { type: "p", text: "A first sprint on one core: leads to close, or customers to service — not «the whole company in a day». Then connections: site, WhatsApp, an AI agent, reports." },
        { type: "p", text: "The goal: one picture of the customer, less copy-paste, and a team that knows the next step without asking in the group chat." },
        { type: "h2", text: "FAQ before you reach out" },
        { type: "p", text: "When is custom CRM worth it vs a sheet? When more than one person owns the same funnel, and statuses scatter across WhatsApp and files." },
        { type: "p", text: "How long until something live? A narrow sprint on one process. A working screen first — expansions later." },
        { type: "p", text: "Can an AI agent connect later? Yes — if there is a source of truth. Without CRM or a clean queue, the agent only speeds up confusion." },
        { type: "p", text: "How to contact now? WhatsApp or the site form. Short note: what the business is and where management breaks today." },
        { type: "h2", text: "Want to check if it fits" },
        { type: "p", text: "Leave a short note — we’ll see together whether custom CRM or wiring your current tools is the right next step." },
        { type: "p", text: "https://wa.me/33632519053?text=%D7%94%D7%99%D7%99%2C%20%D7%90%D7%A9%D7%9E%D7%97%20%D7%9C%D7%93%D7%91%D7%A8%20%D7%A2%D7%9C%20CRM%20%D7%91%D7%94%D7%AA%D7%90%D7%9E%D7%94" },
        { type: "p", text: "https://beosystem.com/#contact" },
      ],
    },
