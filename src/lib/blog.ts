...
export const posts: BlogPost[] = [
  ...
  },
  {
    ...
    body: {
      ...
      en: [
        { type: "p", text: "Many businesses search for a «business chatbot» and expect it to close leads. Then they find: there are chats on the site, but no CRM record, no WhatsApp on time, and no person who continues when needed." },
        { type: "p", text: "Beo System (ביו סיסטם, ביוסיסטם) builds both chat and AI agents — but starts from the right question: do you need answers, or a process that closes." },
        { type: "h2", text: "What a chatbot does well" },
        { type: "p", text: "After-hours replies, FAQs, first-pass screening, and a pointer to a page or form. When the goal is to cut repetitive questions — a page chat is enough." },
        ...
        { type: "p", text: "An agent reads the request, classifies intent, writes to CRM or a queue, sends WhatsApp by rule, and hands off to a person when there is an exception or approval." },
        { type: "p", text: "The metric is not «how many messages». The metric is whether the lead reached the right place, with context, on time." },
        { type: "h2", text: "How to choose without buying both worlds" },
        { type: "p", text: "If most requests are repeating questions and there is no active sales funnel — start with chat. If leads vanish between the site, WhatsApp, and a spreadsheet — start with an agent on one narrow process." },
        { type: "p", text: "You can grow: answers first, then a system connection. The reverse order without a source of truth only speeds up confusion." },
        { type: "h2", text: "What Beo System checks before install" },
        { type: "p", text: "Where requests enter today. Which system is the source of truth. Who approves a quote or a call. And what happens when classification is wrong." },
        { type: "p", text: "We work with businesses in Israel (Kiryat Bialik) and Dubai: site, CRM, and agents wired to data — not three vendors with holes in the middle." },
        { type: "h2", text: "FAQ before you reach out" },
        { type: "p", text: "When is a chatbot enough? When the top goal is answers and FAQs, and leads are already handled elsewhere in a stable way." },
        { type: "p", text: "When do you move to an agent? When requests come in, but there is no one process that reaches CRM and the team on time." },
        { type: "p", text: "Can you start small? Yes — a sprint on one process (the site or `/#contact` to WhatsApp), without a full «AI department»." },
        { type: "p", text: "How to contact now? WhatsApp or the site form. A short note: what the business is and what breaks between chat and the team." },
        { type: "h2", text: "Want to check what fits you" },
        { type: "p", text: "Leave a short request — we’ll see together whether chat, an agent, or a connection between the two is the right step." },
        { type: "p", text: "https://wa.me/33632519053?text=%D7%94%D7%99%D7%99%2C%20%D7%90%D7%A9%D7%9E%D7%97%20%D7%9C%D7%93%D7%91%D7%A8%20%D7%A2%D7%9C%20%D7%A6%D7%90%D7%98%D7%91%D7%95%D7%98%20%D7%9E%D7%95%D7%9C%20%D7%A1%D7%95%D7%9B%D7%9F%20AI" },
        { type: "p", text: "https://beosystem.com/#contact" },
      ],
    },
