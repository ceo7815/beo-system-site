...
const copy = {
  he: {
    ...
    navHome: "דף הבית",
    navAbout: "מי אנחנו",
    navProjects: "פרוייקטים",
    navBlog: "בלוג",
    navContact: "צרו קשר",
    privacy: "מדיניות פרטיות",
    accessibility: "הצהרת נגישות",
    footerRights: "© ביו סיסטם (ביוסיסטם) · Beo System · כל הזכויות שמורות",
    ...
    aboutKicker: "מי אנחנו",
    aboutTitle: "ביו סיסטם",
    aboutParas: [
    ...
    projectsTitle: "פרוייקטים",
    projectsLead: "פרויקטים שבנינו — אפליקציות, אתרים, סוכני AI ומערכות ניהול.",
    projectsLive: "לאתר החי",
    projectsDownload: "הורדה מ־",
  },
  en: {
    talk: "Talk to us",
    scroll: "Scroll",
    ...
    footerRights: "© Beo System (ביו סיסטם / ביוסיסטם) · All rights reserved",
    ...
    aboutTitle: "Beo System",
    aboutParas: [
      "Beo System (ביו סיסטם / ביוסיסטם) builds apps, websites, and AI systems — smart platforms, automations, and agents connected to how the business actually works.",
    ...
    projectsLead: "Work we built — apps, websites, AI agents, and operating systems.",
    projectsLive: "Open live",
    projectsDownload: "Download on",
  },
} as const;
